...
- [Vue入门](#vue入门)
  ...
  - [三、 Vue 指令](#三-vue-指令)
    - [1. 什么是指令](#1-什么是指令)
    - [2. Vue 常见指令](#2-vue-常见指令)
  - [四、 监听器 watch](#四-监听器-watch)
  - [五、 计算属性 computed](#五-计算属性-computed)
  - [六、 案例 音乐播放](#六-案例-音乐播放)
...
![img](https://s2.loli.net/2023/10/15/se731nCVf89zXk2.png)
...
![ ](https://s2.loli.net/2023/10/15/x5TL4MVpnBaicE9.png)
